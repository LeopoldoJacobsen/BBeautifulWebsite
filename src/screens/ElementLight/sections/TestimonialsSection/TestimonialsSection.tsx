    ...
    <section className="relative w-full">
      ...
      <div className="relative w-full bg-gradient-to-b from-white to-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mb-6">
              <h2 className="text-5xl font-bold text-[#c292a1] mb-2">Bbeautiful</h2>
              <p className="text-2xl text-[#874c62] font-medium">Medical Spa</p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
            ...
            <div className="relative">
              <div className="w-[400px] h-[230px] transform rotate-[-8deg] hover:rotate-[-4deg] transition-transform duration-300">
                <div className="h-full rounded-3xl shadow-2xl bg-gradient-to-br from-[#c292a1] to-[#a87b96] flex items-center justify-center">
                  <div className="text-center text-white">
                    <h3 className="text-3xl font-bold mb-2">$50</h3>
                    <p className="text-lg">Gift Card</p>
                    <p className="text-sm opacity-90">Bbeautiful Medical Spa</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="w-full bg-gradient-to-r from-[#f8f5f0] to-[#f4f0ea] py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-6xl font-bold text-[#c292a1] mb-4">Bbeautiful</h2>
          <p className="text-2xl text-[#874c62] font-medium mb-8">Medical Spa & Wellness Center</p>
            ...
            {treatmentCategories.map((category) => (
              <div key={category.id} className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-2xl shadow-lg mb-4">
                  <div className={`w-full h-[400px] bg-gradient-to-br ${category.gradient} transition-transform duration-500 group-hover:scale-105 flex items-center justify-center`}>
                    <div className="text-center text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="relative flex justify-center">
              <div className="relative w-[300px] h-[250px]">
                <div className="absolute w-[240px] h-[140px] top-4 left-2 rounded-2xl transform rotate-[-8deg] shadow-xl bg-gradient-to-br from-blue-400 to-purple-500 transition-transform duration-300 hover:rotate-[-4deg] flex items-center justify-center">
                  <span className="text-white font-bold text-lg">Contest Prize</span>
                </div>
                <div className="absolute w-[240px] h-[140px] top-[100px] left-[45px] rounded-2xl transform rotate-[8deg] shadow-xl bg-gradient-to-br from-green-400 to-blue-500 transition-transform duration-300 hover:rotate-[4deg] flex items-center justify-center">
                  <span className="text-white font-bold text-lg">Win Big!</span>
                </div>
              </div>
            </div>
      ...
      {/* Second Banner */}
      <div className="w-full bg-gradient-to-r from-[#c292a1] to-[#a87b96] py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-12">
            ...
            <div className="w-[240px] h-[120px] bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg flex items-center justify-center">
              <span className="text-gray-600 font-bold text-lg">Biologique Recherche</span>
            </div>
            <div className="w-[240px] h-[120px] bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg flex items-center justify-center">
